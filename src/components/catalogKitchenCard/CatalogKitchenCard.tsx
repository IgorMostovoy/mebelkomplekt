...
const CatalogKitchenCard = () => {
  ...
  return (
    <Box mb="50px" padding="70px 20px">
      {kitchens
        .filter((kitchen) => title === kitchen.title)
        .map((kitchen) => (
