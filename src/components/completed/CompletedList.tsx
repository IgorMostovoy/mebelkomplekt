...
const CompletedList = ({image, title, cost}: CompletedProjectsItemProps) => {
  ...
  return (
    <>
      <Flex direction="column" m='0 15px'
            flexBasis='100%'>
    <Box
      ...
      <Box
        ...
        zIndex={1}
      />
      <Image src={image} cursor='pointer' transition='0.3s'
             w="100%"
             h="100%"
      />
      <Box
...
<Box>
  <Flex justifyContent='space-between'>
    <Text fontFamily='SangBleuSunrise-Regular-WebXL' fontSize='1.1rem' fontWeight='500'
          mb='10px'>Кухня {title}</Text>
    <Text fontFamily='SangBleuSunrise-Regular-WebXL' fontSize='1.1rem' fontWeight='600'
          mb='10px' color='#BF2B45'>{cost} ₽</Text>
  </Flex>
