...
const buttonTitles = [{title: 'Эконом', id: 'econom'}, {title: 'Стандарт', id: 'standart'}, {
  title: 'Премиум',
  id: 'premium'
}]
  ...
  return (
    <Center>
      <Card variant='funky'>
        ...
        <CardFooter p='0'>
          <Flex display='flex' justifyContent='space-between' p='5px 20px' width='100%' fontSize='18px'
        ...
        <CardFooter p='5px' fontFamily='SangBleuSunrise-Light-WebXL'>
          <Flex display='flex' p='3px 15px' justifyContent='space-between' width='100%'
          >
            <Text mt='4px' whiteSpace='nowrap' color='rgba(0,0,0,0.5)' fontWeight='600'>{length}</Text>
            <Text fontWeight='600' fontSize='20px'>

              <Box as='span' color='#BF2B45'>{cost[activeIndex]}</Box> руб.
